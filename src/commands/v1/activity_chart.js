...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v1_activity_chart').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
