    ...
    async execute(interaction) {
        try {
            ...
            if (!userRecord || !userRecord.staff) {
                return const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v1_case_file').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
            ...
            await const row = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId('auto_v1_case_file').setLabel('� Sync Live Data').setStyle(ButtonStyle.Secondary));
